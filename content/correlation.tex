...
previous section, one can compute that there is about \SI{420}{ppb}
\ch{NO2} in the cylinder, if all of it stemmed from \ch{NO} this would
introduce an error of about \SI{5}{\percent} (the calibration
concentration given was $c = \SI{8.177}{ppm}$). This is not enough to
explain the discrepancy. Together with the fact that I still cannot
explain, how the transition from \ch{NO} to \ch{NO2} could occur, I
...
necessary to understand the corrections necessary. Possibly, the
...
further I suggest to perform additional decay measurements as proposed
