...
emission (the so called Euro 6 norms) are only concerned \ch{NO_x}
...
the deviation of the \ch{NO2} averages points towards outer
...
hand the setup seems to work as very well for indirect \ch{NO}
...
concentration is the most volatile and the \ch{CO2} curve follows it
...
three times higher \ch{NO2} ratio, but the \ch{NO_x} ratio does not
