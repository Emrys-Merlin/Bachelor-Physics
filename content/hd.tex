...
resolution of \SI{1}{\second}. As \ch{NO2} cell I used the
...
possessing a \ch{CO2} sensor. This allowed the computation of the
...
Regarding the consequences of this finding, this difference is not
