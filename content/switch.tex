...
\ch{NO2} signal coming from the slow tail at constant \ch{NO} flow
...
Reaction~\eqref{eq:no} to be the diminishing \ch{O3} concentration,
...
\ch{NO} concentration, then we should be able to mitigate the effects
of the tail, by subtracting the above computed average slow tail
concentration $\bar c_s$ from the measured \ch{NO2}
