...
to \ch{NO2}. Looking at Reaction~\eqref{eq:no}, we see that this
...
had a constant supply of \ch{NO}, such that the behaviour of the
...
\ch{NO2} signal due to the flank by
...
decay form to be mainly \ch{NO} independent. This assumption might be
