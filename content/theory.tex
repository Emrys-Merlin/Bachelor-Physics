...
if the number is higher than $4000$ (c.\,f.~\cite{gerthsen}). In our
system we have $d = \SI{4}{\milli\meter}$, $\rho \approx
\SI{1.2}{\kilo\gram\per\cubic\meter}$ and $\eta \approx
\SI{17.1}{\micro\pascal\second}$. Further more we work with a flow of
...
Thus we see that we work solely in the laminar setting. 
