...
barriers\todo{which ones?}. These will enter our Ozone generator and
afterwards they will react with \ch{O3} and lead to \ch{NO2} in our
otherwise \ch{NO2} free air stream. This is a problem, as any \ch{NO2}
...
weight in water \todo{cite?} and extends this capacity to molecules
which are easily solible, like \ch{NO2}. Hence we can utilize a Silica
filter to clean our generator air of \ch{NO2}. At first the filter
